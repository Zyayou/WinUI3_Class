...
namespace winrt::Andong_Nation_University::implementation
{
    MainWindow::MainWindow()
    {
        ...
        SetWindowPos(hWnd, NULL, 200, 200, 1050, 700, NULL);
...
void winrt::Andong_Nation_University::implementation::MainWindow::myWrite_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    // Open for write
    FILE* fw;
    errno_t err;
    err = fopen_s(&fw, "C:/Users/comeng11/Desktop1.txt", "w");// +, ccs = UTF - 8");
    if (err == 0)
    {
...
void winrt::Andong_Nation_University::implementation::MainWindow::myRead_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    // Open for write
    FILE* fr;
    errno_t err;
    err = fopen_s(&fr, "C:/Users/comeng11/Desktop1.txt", "r");// +, ccs = UTF - 8");
    if (err == 0)
    {
        //  MessageBox(NULL, L"The file was opened\n", L"hi1", NULL);
        vx.clear();
...
void winrt::Andong_Nation_University::implementation::MainWindow::CanvasControl_PointerEntered(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::PointerRoutedEventArgs const& e)
{
    CanvasControl canvas = sender.as<CanvasControl>();
    canvas.Invalidate();
}
...
void winrt::Andong_Nation_University::implementation::MainWindow::myClear_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    vx.clear();
    vy.clear();
    col.clear();
...
void winrt::Andong_Nation_University::implementation::MainWindow::MenuFlyoutItem_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    vx.clear();
    vy.clear();
    size.clear();
...
void winrt::Andong_Nation_University::implementation::MainWindow::MenuFlyoutItem_Click_1(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    //저장
    FILE* fp;
    fopen_s(&fp, "C:/Users/comeng11/Desktop1.txt", "w");
...
void winrt::Andong_Nation_University::implementation::MainWindow::MenuFlyoutItem_Click_2(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    //불러오기
    FILE* fp;
    fopen_s(&fp, "C:/Users/comeng11/Desktop1.txt", "r");
...
void winrt::Andong_Nation_University::implementation::MainWindow::MenuFlyoutItem_Click_3(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    this->Close();
}


void winrt::Andong_Nation_University::implementation::MainWindow::Button2_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    if (IsChecked2)
    {
        IsChecked2 = FALSE;
